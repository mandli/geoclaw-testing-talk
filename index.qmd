...
Kyle Mandli  
GeoClaw Users' Workshop 2026

::: notes
Today I want to show a slightly different way to think about using GeoClaw.

This is not really a talk about testing frameworks.
It is about making it easier to trust, reuse, and scale the simulations that people are already running.

[Sources]
- Workshop page: https://www.clawpack.org/geoclaw-users-2026/
::: -->
...
We start from an example, tweak a few parameters, run it, look at the plots, and then repeat.
...
The key difference is that comparison is now explicit.
...
So this is already more than “did the code run?”
